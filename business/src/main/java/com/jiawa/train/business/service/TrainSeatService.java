...
public class TrainSeatService {
    ...
    public PageResp<TrainSeatQueryResp> queryList(TrainSeatQueryReq req) {
        ...
        trainSeatExample.setOrderByClause("train_code, carriage_index, carriage_seat_index");
    ...
    public void genTrainSeat(String trainCode) {
        ...
        for (TrainCarriage trainCarriage : trainCarriageList) {
            ...
            // 根据车厢的座位类型，筛选出所有的列，比如车厢的类型是一等座，则筛选出columnList={ACDF}
    ...
    public List<TrainSeat> selectByTrainCode(String trainCode) {
        TrainSeatExample trainSeatExample = new TrainSeatExample();
        trainSeatExample.setOrderByClause("`id`");
        trainSeatExample.createCriteria().andTrainCodeEqualTo(trainCode);
